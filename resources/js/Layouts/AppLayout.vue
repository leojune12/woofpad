            ...
            <nav class="bg-white border-b border-gray-100 w-full sticky top-0">
                    ...
                    <div class="flex justify-between items-center h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <div v-else class="flex">
                                <inertia-link :href="route('login')" class="mr-3">
                                    <button
                                        class="px-4 py-2 w-full focus:outline-none rounded-lg border font-bold text-app-color bg-purple-100 border-purple-200 hover:bg-purple-200"
                                    >
                                        Sign in
                                    </button>
                                </inertia-link>
                                <inertia-link :href="route('register')">
                                    <button
                                        class="px-4 py-2 w-full focus:outline-none rounded-lg border bg-app-color text-white font-bold"
                                    >
                                        Join
                                    </button>
                                </inertia-link>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    ...
                    <div v-else class="flex flex-col p-4">
                        <inertia-link :href="route('login')" class="mb-4">
                            <button
                                class="py-3 w-full focus:outline-none rounded-md border font-bold text-app-color bg-purple-100 border-purple-200 hover:bg-purple-200"
                            >
                                Sign in
                            </button>
                        </inertia-link>
                        <inertia-link :href="route('register')">
                            <button
                                class="py-3 w-full focus:outline-none rounded-md border bg-app-color text-white font-bold"
                            >
                                Join
                            </button>
                        </inertia-link>
